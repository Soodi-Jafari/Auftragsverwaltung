...
using Auftragsverwaltung.Web.Settings;
...
namespace Auftragsverwaltung
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AuftragDbContext>(options =>
            {
                options.UseSqlServer(connectionString);
                options.UseLazyLoadingProxies();
            });
            services.AddScoped<IAuftragService, AuftragService>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=Auftrag}/{action=Index}/{id?}");
            });
        }
    }
}
